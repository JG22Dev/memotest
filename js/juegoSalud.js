...
function mostrarModalInicio(onCancel) {
  Swal.fire({
    ...
    html: `
      ...
      <br><input type="range" id="sliderPares" min="2" max="5" value="4" oninput="document.getElementById('sliderValor').textContent = this.value">
    `,
    focusConfirm: false,
...
function iniciarJuego() {
  ...
  cartas.forEach((carta) => {
    ...
    imgReal.src = `../cardSaludMental/${carpeta}/${carta.nombre}`;
    ...
    imgTapada.src = '../cardSaludMental/tapada.png';
